...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-fallback-key-change-in-production-asap')
...
# Note: Only set custom search_path if your Supabase schema is not 'public'
# DATABASES['default']['OPTIONS'] = {
#     'options': '-c search_path=financetracker'
# }
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'kuhunarang@gmail.com'
