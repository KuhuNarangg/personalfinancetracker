...
const TICKER = ["Track Subscriptions", "Kill Forgotten Charges", "Visualize Spending", "Know Your Burn Rate", "Set Savings Goals", "Get Renewal Alerts", "Stop Wasting Money", "Financial Clarity", "Save More", "Optimize Budget"];
